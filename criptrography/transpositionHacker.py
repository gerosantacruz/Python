...
def main():
    #source:  https://www.nostarch.com/crackingcodes/:
...
def hackTransposition(message):
    ...
    #Brute.force by looping through every posible key

    for key in range(1, len(message)):
        print('Trying key #%s..' %(key))
        
        decryptedText = transpositionDecrypt.decrypt_message(key, message)
